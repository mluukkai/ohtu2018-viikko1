...
public class VarastoTest {
    ...
    @Test
    public void varastoEiTaytyYliKapasiteetin() {
    ...
    @Test
    public void varastoPalauttaaVaanSenVerranKuinTalletettuna() {
        varasto.lisaaVarastoon(8);
    ...
    @Test
    public void kaksiparametrinenKonstuktoriAlustaaVarastonOikein() {
    ...
    @Test
    public void kaksiparametrisellaKonstruktorillaLuodunVarastonTilavuusEiVoiOllaNegatiivinen() {
    ...
    @Test
    public void kaksiparametrisellaKonstruktorillaLuodunVarastonAlkusaldoEiVoiOllaNegatiivinen() {
        Varasto v = new Varasto(1, -11);
